...
export const ALL_TOPIC_STRUCTURE: readonly Topic[] = [
  ...
  withAutoIds({
    ...
    questions: [
      ...
      {
        questionId: "read_independent_ifs",
        title: "独立したif文の実行結果を予測できる",
        type: "READ",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "read_if_elseif_chain",
        title: "if-else ifの実行結果を予測できる",
        type: "READ",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "read_if_vs_elseif_difference",
        title: "独立ifとelse ifの動作の違いを見分けられる",
        type: "READ",
        difficulty: Difficulty.Medium,
      },
      {
        questionId: "write_if_basic_fillblank",
        title: "if文の構文を穴埋めで書ける",
        type: "WRITE",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "write_elseif_fillblank",
        title: "if-else if-else文を穴埋めで書ける",
        type: "WRITE",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "read_switch_fallthrough",
  ...
  withAutoIds({
    ...
    questions: [
      {
        questionId: "loop_concept",
        title: "ループとは何かを説明できる",
        type: "KNOW",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "for_syntax_basics",
        title: "for文の基本的な構文を説明できる",
        type: "KNOW",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "while_vs_dowhile",
        title: "while文とdo-while文の違いを説明できる",
        type: "KNOW",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "break_vs_continue",
        title: "breakとcontinueの違いを説明できる",
        type: "KNOW",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "infinite_loop_concept",
        title: "無限ループとは何かを説明できる",
        type: "KNOW",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "for_repeat_basic",
        title: "for文で同じ処理を繰り返せる",
        type: "WRITE",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "for_print_1_to_10",
        title: "for文で1〜10まで表示できる",
        type: "WRITE",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "while_loop_basic",
        title: "while文で条件が満たされる間繰り返せる",
        type: "WRITE",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "dowhile_loop_basic",
        title: "do-while文で最低1回は実行できる",
        type: "WRITE",
        difficulty: Difficulty.Medium,
      },
      {
        questionId: "break_exit_loop",
        title: "breakでループを途中で抜けられる",
        type: "WRITE",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "continue_skip_iteration",
        title: "continueで次の繰り返しにスキップできる",
        type: "WRITE",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "nested_loop",
        title: "二重ループが書ける",
        type: "WRITE",
        difficulty: Difficulty.Medium,
      },
      {
        questionId: "read_loop_execution_count",
        title: "ループのコードを読んで何回実行されるかわかる",
        type: "READ",
        difficulty: Difficulty.Medium,
      },
      {
        questionId: "for_parts_role",
        title: "for文の3つの部分の役割がわかる",
        type: "KNOW",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "read_for_output",
        title: "for文のコードを読んで出力を予測できる",
        type: "READ",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "read_while_output",
        title: "while文のコードを読んで出力を予測できる",
        type: "READ",
        difficulty: Difficulty.Medium,
      },
      {
        questionId: "write_for_fillblank",
        title: "for文の構文を穴埋めで書ける",
        type: "WRITE",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "write_fizzbuzz",
  ...
  withAutoIds({
    ...
    questions: [
      {
        questionId: "array_concept",
        title: "配列とは何かを説明できる",
        type: "KNOW",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "array_index_mechanism",
        title: "配列のインデックスの仕組みを説明できる",
        type: "KNOW",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "array_declaration_init",
        title: "配列の宣言と初期化の方法を説明できる",
        type: "KNOW",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "array_length",
        title: "配列の長さを取得する方法を説明できる",
        type: "KNOW",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "create_array_set_values",
        title: "配列を作って値を入れられる",
        type: "WRITE",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "get_array_value",
        title: "配列の値を取り出せる",
        type: "WRITE",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "for_loop_display_array",
        title: "forループで配列の全要素を表示できる",
        type: "WRITE",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "enhanced_for_loop",
        title: "拡張for文で配列を簡単に処理できる",
        type: "WRITE",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "array_sum_average",
        title: "配列の合計や平均を計算できる",
        type: "WRITE",
        difficulty: Difficulty.Medium,
      },
      {
        questionId: "array_max_min",
        title: "配列から最大値・最小値を見つけられる",
        type: "WRITE",
        difficulty: Difficulty.Medium,
      },
      {
        questionId: "two_dimensional_array",
        title: "2次元配列を使える",
        type: "WRITE",
        difficulty: Difficulty.Medium,
      },
  ...
  withAutoIds({
    ...
    questions: [
      {
        questionId: "method_concept",
        title: "メソッドとは何かを説明できる",
        type: "KNOW",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "void_method_no_args",
        title: "引数なし・戻り値なしのメソッドを作れる",
        type: "WRITE",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "method_with_args",
        title: "引数でメソッドに値を渡せる",
        type: "WRITE",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "method_with_return",
        title: "returnで値を返すメソッドを作れる",
        type: "WRITE",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "void_meaning",
        title: "voidの意味を説明できる",
        type: "KNOW",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "call_method_get_result",
        title: "メソッドを呼び出して結果を受け取れる",
        type: "WRITE",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "method_overloading",
  ...
  withAutoIds({
    ...
    questions: [
      {
        questionId: "package_organization",
        title: "パッケージでクラスを整理できる",
        type: "KNOW",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "import_statement",
        title: "import文で他のクラスを使えるようにできる",
        type: "WRITE",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "multi_class_benefit",
        title: "複数のクラスに処理を分けることのメリットがわかる",
        type: "KNOW",
        difficulty: Difficulty.Medium,
      },
      {
        questionId: "call_other_class_method",
        title: "別のクラスのメソッドを呼び出せる",
        type: "WRITE",
        difficulty: Difficulty.Medium,
      },
      {
        questionId: "eclipse_autocomplete",
        title: "Eclipseの補完機能を使ってコードを速く書ける",
        type: "WRITE",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "multi_class_cooperation",
  ...
  withAutoIds({
    ...
    questions: [
      {
        questionId: "exception_concept",
        title: "例外とは何かを説明できる",
        type: "KNOW",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "try_catch_finally_roles",
        title: "try-catch-finallyの各ブロックの役割を説明できる",
        type: "KNOW",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "throw_vs_throws",
        title: "throwとthrowsの違いを説明できる",
        type: "KNOW",
        difficulty: Difficulty.Medium,
      },
      {
        questionId: "try_catch_basic",
        title: "try-catchでエラーを捕まえて処理できる",
        type: "WRITE",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "multiple_catch",
        title: "catchで複数の例外を処理できる",
        type: "WRITE",
        difficulty: Difficulty.Medium,
      },
      {
        questionId: "finally_block",
        title: "finallyで必ず実行される処理を書ける",
        type: "WRITE",
        difficulty: Difficulty.Medium,
      },
      {
        questionId: "throws_declaration",
        title: "throwsでエラーを呼び出し元に任せられる",
        type: "KNOW",
        difficulty: Difficulty.Medium,
      },
      {
        questionId: "throw_exception",
        title: "throwで自分でエラーを発生させられる",
        type: "WRITE",
        difficulty: Difficulty.Medium,
      },
      {
        questionId: "read_exception_flow",
        title: "例外処理のコードを読んで流れを理解できる",
        type: "READ",
        difficulty: Difficulty.Medium,
      },
      {
        questionId: "exception_io_network",
  ...
  withAutoIds({
    ...
    questions: [
      {
        questionId: "class_object_relation",
        title: "クラスとオブジェクトの関係を説明できる",
        type: "KNOW",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "oop_concept",
        title: "オブジェクト指向とは何かを説明できる",
        type: "KNOW",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "field_vs_method",
        title: "フィールドとメソッドの違いを説明できる",
        type: "KNOW",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "field_store_data",
        title: "フィールドでデータを保存できる",
        type: "WRITE",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "new_keyword_create_object",
        title: "newキーワードでオブジェクトを作れる",
        type: "WRITE",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "call_instance_method",
        title: "インスタンスメソッドを呼び出せる",
        type: "WRITE",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "static_vs_instance",
        title: "staticメソッドとインスタンスメソッドの違いがわかる",
        type: "KNOW",
        difficulty: Difficulty.Medium,
      },
      {
        questionId: "multiple_objects",
        title: "同じクラスから複数のオブジェクトを作れる",
        type: "WRITE",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "class_with_fields_methods",
        title: "フィールドとメソッドを持つクラスを作れる",
        type: "WRITE",
        difficulty: Difficulty.Medium,
      },
      {
        questionId: "object_array",
  ...
  withAutoIds({
    ...
    questions: [
      {
        questionId: "constructor_concept",
        title: "コンストラクタとは何かを説明できる",
        type: "KNOW",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "constructor_vs_method",
        title: "コンストラクタとメソッドの違いを説明できる",
        type: "KNOW",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "this_keyword_role",
        title: "thisキーワードの役割を説明できる",
        type: "KNOW",
        difficulty: Difficulty.Medium,
      },
      {
        questionId: "constructor_init_field",
        title: "コンストラクタでフィールドに初期値を設定できる",
        type: "WRITE",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "constructor_with_args",
        title: "引数ありのコンストラクタを作れる",
        type: "WRITE",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "this_keyword_usage",
        title: "thisキーワードでフィールドを指定できる",
        type: "WRITE",
        difficulty: Difficulty.Medium,
      },
      {
        questionId: "constructor_overloading",
        title: "引数が違う複数のコンストラクタを作れる",
        type: "WRITE",
        difficulty: Difficulty.Medium,
      },
      {
        questionId: "default_constructor",
        title: "デフォルトコンストラクタの仕組みを説明できる",
        type: "KNOW",
        difficulty: Difficulty.Medium,
      },
      {
        questionId: "this_constructor_call",
        title: "this()で別のコンストラクタを呼び出せる",
        type: "WRITE",
        difficulty: Difficulty.Medium,
      },
      {
        questionId: "constructor_validation",
  ...
  withAutoIds({
    ...
    questions: [
      {
        questionId: "inheritance_concept",
        title: "継承とは何かを説明できる",
        type: "KNOW",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "extends_keyword",
        title: "extendsで親クラスを指定できる",
        type: "WRITE",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "use_parent_method",
        title: "子クラスで親のメソッドを使える",
        type: "WRITE",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "super_method_call",
        title: "superで親のメソッドを呼び出せる",
        type: "WRITE",
        difficulty: Difficulty.Medium,
      },
      {
        questionId: "super_constructor_call",
        title: "super()で親のコンストラクタを呼び出せる",
        type: "WRITE",
        difficulty: Difficulty.Medium,
      },
      {
        questionId: "method_override",
        title: "メソッドをオーバーライドして動きを変えられる",
        type: "WRITE",
        difficulty: Difficulty.Medium,
      },
      {
        questionId: "override_annotation",
        title: "@Overrideアノテーションを付けられる",
        type: "WRITE",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "overload_vs_override",
        title: "オーバーロードとオーバーライドの違いがわかる",
        type: "KNOW",
        difficulty: Difficulty.Medium,
      },
      {
        questionId: "polymorphism_basic",
        title: "親クラス型で子クラスのオブジェクトを扱える",
        type: "WRITE",
        difficulty: Difficulty.Medium,
      },
      {
        questionId: "inheritance_appropriate_use",
  ...
  withAutoIds({
    ...
    questions: [
      {
        questionId: "interface_concept",
        title: "インターフェースとは何かを説明できる",
        type: "KNOW",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "create_interface",
        title: "interfaceでインターフェースを作れる",
        type: "WRITE",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "implements_interface",
        title: "implementsでインターフェースを実装できる",
        type: "WRITE",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "interface_method_feature",
        title: "インターフェースのメソッド定義の特徴を説明できる",
        type: "KNOW",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "implement_all_methods",
        title: "実装クラスで全てのメソッドを実装できる",
        type: "WRITE",
        difficulty: Difficulty.Medium,
      },
      {
        questionId: "multiple_interfaces",
        title: "複数のインターフェースを実装できる",
        type: "WRITE",
        difficulty: Difficulty.Medium,
      },
      {
        questionId: "interface_type_polymorphism",
        title: "インターフェース型で複数のクラスをまとめて扱える",
        type: "WRITE",
        difficulty: Difficulty.Medium,
      },
      {
        questionId: "default_method_role",
        title: "defaultメソッドの役割を説明できる",
        type: "KNOW",
        difficulty: Difficulty.Medium,
      },
      {
        questionId: "inheritance_vs_interface",
  ...
  withAutoIds({
    ...
    questions: [
      {
        questionId: "encapsulation_concept",
        title: "カプセル化とは何かを説明できる",
        type: "KNOW",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "private_field",
        title: "フィールドをprivateにできる",
        type: "WRITE",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "getter_method",
        title: "getterで値を取得するメソッドを作れる",
        type: "WRITE",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "setter_method",
        title: "setterで値を設定するメソッドを作れる",
        type: "WRITE",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "public_vs_private",
        title: "publicとprivateの違いがわかる",
        type: "KNOW",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "protected_vs_default",
        title: "protectedとデフォルトアクセスの違いがわかる",
        type: "KNOW",
        difficulty: Difficulty.Medium,
      },
      {
        questionId: "setter_validation",
        title: "setterで値をチェックして不正な値を防げる",
        type: "WRITE",
        difficulty: Difficulty.Medium,
      },
      {
        questionId: "readonly_field",
        title: "読み取り専用のフィールドを作れる",
        type: "WRITE",
        difficulty: Difficulty.Medium,
      },
      {
        questionId: "class_design_access",
  ...
  withAutoIds({
    ...
    questions: [
      {
        questionId: "arraylist_feature",
        title: "ArrayListの特徴を説明できる",
        type: "KNOW",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "array_vs_arraylist",
        title: "配列とArrayListの違いを説明できる",
        type: "KNOW",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "generics_concept",
        title: "ジェネリクスとは何かを説明できる",
        type: "KNOW",
        difficulty: Difficulty.Medium,
      },
      {
        questionId: "arraylist_add",
        title: "ArrayListに要素を追加できる",
        type: "WRITE",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "arraylist_get",
        title: "ArrayListから要素を取得できる",
        type: "WRITE",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "arraylist_remove",
        title: "ArrayListから要素を削除できる",
        type: "WRITE",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "hashset_usage",
        title: "HashSetで重複しないデータを管理できる",
        type: "WRITE",
        difficulty: Difficulty.Medium,
      },
      {
        questionId: "hashmap_usage",
        title: "HashMapでキーと値のペアを保存できる",
        type: "WRITE",
        difficulty: Difficulty.Medium,
      },
      {
        questionId: "generics_type_param",
        title: "ジェネリクスで型を指定できる",
        type: "WRITE",
        difficulty: Difficulty.Medium,
      },
      {
        questionId: "list_set_map_choice",
        title: "List、Set、Mapの使い分けができる",
        type: "KNOW",
        difficulty: Difficulty.Medium,
      },
      {
        questionId: "collection_loop",
  ...
  withAutoIds({
    ...
    questions: [
      {
        questionId: "localdate_time_datetime",
        title: "LocalDate、LocalTime、LocalDateTimeの違いを説明できる",
        type: "KNOW",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "datetimeformatter_role",
        title: "DateTimeFormatterの役割を説明できる",
        type: "KNOW",
        difficulty: Difficulty.Medium,
      },
      {
        questionId: "get_today_date",
        title: "LocalDateで今日の日付を取得できる",
        type: "WRITE",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "get_current_time",
        title: "LocalTimeで現在時刻を取得できる",
        type: "WRITE",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "localdatetime_usage",
        title: "LocalDateTimeで日付と時刻を一緒に扱える",
        type: "WRITE",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "date_plus_minus",
        title: "日付に日数を足したり引いたりできる",
        type: "WRITE",
        difficulty: Difficulty.Medium,
      },
      {
        questionId: "date_difference",
        title: "2つの日付の差を計算できる",
        type: "WRITE",
        difficulty: Difficulty.Medium,
      },
      {
        questionId: "datetime_format",
        title: "DateTimeFormatterで日付を好きな形式で表示できる",
        type: "WRITE",
        difficulty: Difficulty.Medium,
      },
      {
        questionId: "period_vs_duration",
        title: "PeriodとDurationの違いがわかる",
        type: "KNOW",
        difficulty: Difficulty.Medium,
      },
      {
        questionId: "datetime_immutability",
  ...
  withAutoIds({
    ...
    questions: [
      {
        questionId: "http_definition",
        title: "HTTPとは何かを説明できる",
        type: "KNOW",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "get_vs_post",
        title: "GETとPOSTの違いを説明できる",
        type: "KNOW",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "status_code_meaning",
        title: "HTTPステータスコードを読める",
        type: "KNOW",
        difficulty: Difficulty.Medium,
      },
      {
        questionId: "url_structure",
        title: "URLの構造を説明できる",
        type: "KNOW",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "request_response_flow",
        title: "リクエストとレスポンスの流れを説明できる",
        type: "KNOW",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "read_status_codes",
        title: "コードからステータスを読み取れる",
        type: "READ",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "write_url_parts",
        title: "URLのパスとクエリパラメータを区別できる",
        type: "WRITE",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "webapp_vs_static",
  ...
  withAutoIds({
    ...
    questions: [
      {
        questionId: "mvc_roles",
        title: "MVCの各要素を説明できる",
        type: "KNOW",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "model_role",
        title: "Modelの役割を説明できる",
        type: "KNOW",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "view_role",
        title: "Viewの役割を説明できる",
        type: "KNOW",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "controller_role",
        title: "Controllerの役割を説明できる",
        type: "KNOW",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "mvc_separation_benefit",
        title: "MVCで役割を分けるメリットを説明できる",
        type: "KNOW",
        difficulty: Difficulty.Medium,
      },
      {
        questionId: "request_to_response_flow",
        title: "ユーザー操作から画面表示までの流れを説明できる",
        type: "READ",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "framework_benefit",
        title: "フレームワークのメリットを説明できる",
        type: "KNOW",
        difficulty: Difficulty.Medium,
      },
      {
        questionId: "mvc_code_organization",
  ...
  withAutoIds({
    id: "03_spring_hello",
    label: "Springの基本構成とHello World",
    category: "spring",
    questions: [
      {
        questionId: "spring_initializr_role",
        title: "Spring Initializrの役割を説明できる",
        type: "KNOW",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "spring_boot_app_annotation",
        title: "@SpringBootApplicationの役割を説明できる",
        type: "KNOW",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "project_structure",
        title: "プロジェクト構成を説明できる",
        type: "KNOW",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "pom_xml_role",
        title: "pom.xmlの役割を説明できる",
        type: "KNOW",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "read_hello_controller",
        title: "コントローラとビューの対応を読み取れる",
        type: "READ",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "read_response_body",
        title: "@ResponseBodyのあるなしの違いを読み取れる",
        type: "READ",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "write_controller_basic",
        title: "@Controllerでビューを返すコントローラを作れる",
        type: "WRITE",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "write_thymeleaf_basic",
  ...
  withAutoIds({
    ...
    questions: [
      ...
      {
        questionId: "controller_annotation",
        title: "@Controllerアノテーションの役割を説明できる",
        type: "KNOW",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "write_controller_class",
        title: "@Controllerでコントローラクラスを作れる",
        type: "WRITE",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "write_get_mapping",
        title: "@GetMappingでURLと処理を紐付けられる",
        type: "WRITE",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "write_return_view",
        title: "メソッドからビュー名を返せる",
        type: "WRITE",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "write_post_mapping",
        title: "@PostMappingでフォーム送信を受け取れる",
        type: "WRITE",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "get_post_usage",
        title: "@GetMappingと@PostMappingの使い分けができる",
        type: "KNOW",
        difficulty: Difficulty.Medium,
      },
      {
        questionId: "read_url_to_method",
        title: "URLからどのメソッドが実行されるか判断できる",
        type: "READ",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "read_controller_not_found",
        title: "コントローラが検出されない原因を推測できる",
        type: "READ",
        difficulty: Difficulty.Medium,
      },
      {
        questionId: "request_mapping_usage",
  ...
  withAutoIds({
    ...
    questions: [
      {
        questionId: "what_is_request_param",
        title: "リクエストパラメータとは何かを説明できる",
        type: "KNOW",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "request_param_annotation",
        title: "@RequestParamの役割を説明できる",
        type: "KNOW",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "path_variable_annotation",
        title: "@PathVariableの役割を説明できる",
        type: "KNOW",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "write_request_param",
        title: "@RequestParamでクエリパラメータを受け取れる",
        type: "WRITE",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "write_path_variable",
        title: "@PathVariableでURLの一部を受け取れる",
        type: "WRITE",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "query_vs_path",
        title: "クエリパラメータとパスパラメータの違いがわかる",
        type: "KNOW",
        difficulty: Difficulty.Medium,
      },
      {
        questionId: "write_form_object",
        title: "フォームオブジェクトで複数の値をまとめて受け取れる",
        type: "WRITE",
        difficulty: Difficulty.Medium,
      },
      {
        questionId: "read_url_params",
        title: "URLから送られた値を読み取れる",
        type: "READ",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "write_optional_param",
  ...
  withAutoIds({
    ...
    questions: [
      {
        questionId: "what_is_thymeleaf",
        title: "Thymeleafとは何かを説明できる",
        type: "KNOW",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "model_object_role",
        title: "Modelオブジェクトの役割を説明できる",
        type: "KNOW",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "th_text_vs_utext",
        title: "th:textとth:utextの違いを説明できる",
        type: "KNOW",
        difficulty: Difficulty.Medium,
      },
      {
        questionId: "thymeleaf_attributes",
        title: "Thymeleafの主要な属性を説明できる",
        type: "KNOW",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "write_add_attribute",
        title: "ModelのaddAttributeで値を渡せる",
        type: "WRITE",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "write_th_text",
        title: "th:textで値を画面に表示できる",
        type: "WRITE",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "write_inline_text",
        title: "[[...]]で値を埋め込める",
        type: "WRITE",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "write_th_if",
        title: "th:ifで条件によって表示を変えられる",
        type: "WRITE",
        difficulty: Difficulty.Medium,
      },
      {
        questionId: "write_th_each",
        title: "th:eachで繰り返し表示できる",
        type: "WRITE",
        difficulty: Difficulty.Medium,
      },
      {
        questionId: "write_th_object",
        title: "th:objectでオブジェクトを簡潔に参照できる",
        type: "WRITE",
        difficulty: Difficulty.Medium,
      },
      {
        questionId: "utext_caution",
        title: "th:utextの注意点を説明できる",
        type: "KNOW",
        difficulty: Difficulty.Medium,
      },
      {
        questionId: "write_utilities",
        title: "#stringsなどのユーティリティを使える",
        type: "WRITE",
        difficulty: Difficulty.Medium,
      },
      {
        questionId: "write_fragment",
  ...
  withAutoIds({
    ...
    questions: [
      ...
      {
        questionId: "validation_annotations",
        title: "主要なバリデーションアノテーションを説明できる",
        type: "KNOW",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "binding_result_role",
        title: "BindingResultの役割を説明できる",
        type: "KNOW",
        difficulty: Difficulty.Medium,
      },
      {
        questionId: "write_not_null",
        title: "@NotBlankで必須チェックができる",
        type: "WRITE",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "write_min_max",
        title: "@Min/@Maxで数値の範囲をチェックできる",
        type: "WRITE",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "write_email",
        title: "@Emailでメール形式をチェックできる",
        type: "WRITE",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "write_validated",
        title: "@Validatedでバリデーションを実行できる",
        type: "WRITE",
        difficulty: Difficulty.Medium,
      },
      {
        questionId: "write_binding_result",
        title: "BindingResultでエラーを受け取れる",
        type: "WRITE",
        difficulty: Difficulty.Medium,
      },
      {
        questionId: "write_th_errors",
        title: "th:errorsでエラーメッセージを表示できる",
        type: "WRITE",
        difficulty: Difficulty.Medium,
      },
      {
        questionId: "cross_field_validation",
        title: "@AssertTrueで相関チェックができる",
        type: "WRITE",
        difficulty: Difficulty.Medium,
      },
      {
        questionId: "write_retain_input",
  ...
  withAutoIds({
    ...
    questions: [
      {
        questionId: "what_is_di",
        title: "DIとは何かを説明できる",
        type: "KNOW",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "write_service_class",
        title: "@Serviceでサービスクラスを作れる",
        type: "WRITE",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "write_constructor_injection",
        title: "コンストラクタでサービスを受け取れる",
        type: "WRITE",
        difficulty: Difficulty.Medium,
      },
      {
        questionId: "autowired_mechanism",
        title: "@Autowiredの仕組みがわかる",
        type: "KNOW",
        difficulty: Difficulty.Medium,
      },
      {
        questionId: "component_annotations",
        title: "各コンポーネントアノテーションの違いがわかる",
        type: "KNOW",
        difficulty: Difficulty.Medium,
      },
      {
        questionId: "new_vs_di",
        title: "newとDIの使い分けを判断できる",
        type: "READ",
        difficulty: Difficulty.Medium,
      },
      {
        questionId: "write_primary",
        title: "@Primaryで優先するBeanを指定できる",
        type: "WRITE",
        difficulty: Difficulty.Medium,
      },
      {
        questionId: "write_interface_di",
  ...
  withAutoIds({
    ...
    questions: [
      {
        questionId: "what_is_orm",
        title: "O/Rマッパーとは何かを説明できる",
        type: "KNOW",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "mybatis_role",
        title: "MyBatisの役割を説明できる",
        type: "KNOW",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "annotation_vs_xml_mapper",
        title: "アノテーションマッパーとXMLマッパーの違いを説明できる",
        type: "KNOW",
        difficulty: Difficulty.Medium,
      },
      {
        questionId: "result_map_role",
        title: "resultMapの役割を説明できる",
        type: "KNOW",
        difficulty: Difficulty.Medium,
      },
      {
        questionId: "write_mapper_interface",
        title: "@Mapperでデータアクセスクラスを作れる",
        type: "WRITE",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "write_select_annotation",
        title: "@SelectでSELECT文を実行できる",
        type: "WRITE",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "write_xml_mapper",
        title: "XMLマッパーでSQLを書ける",
        type: "WRITE",
        difficulty: Difficulty.Medium,
      },
      {
        questionId: "write_schema_sql",
        title: "schema.sqlでテーブルを作れる",
        type: "WRITE",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "write_data_sql",
        title: "data.sqlで初期データを入れられる",
        type: "WRITE",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "write_result_map",
        title: "resultMapでテーブルとJavaオブジェクトを紐付けられる",
        type: "WRITE",
        difficulty: Difficulty.Medium,
      },
      {
        questionId: "write_one_to_many",
        title: "1対多のリレーションをresultMapで表現できる",
        type: "WRITE",
        difficulty: Difficulty.Hard,
      },
      {
        questionId: "write_application_properties",
  ...
  withAutoIds({
    ...
    questions: [
      {
        questionId: "what_is_session",
        title: "セッションとは何かを説明できる",
        type: "KNOW",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "session_vs_request_scope",
        title: "セッションスコープとリクエストスコープの違いを説明できる",
        type: "KNOW",
        difficulty: Difficulty.Medium,
      },
      {
        questionId: "http_session_role",
        title: "HttpSessionオブジェクトの役割を説明できる",
        type: "KNOW",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "write_set_attribute",
        title: "HttpSessionで値を保存できる",
        type: "WRITE",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "write_get_attribute",
        title: "HttpSessionで値を取得できる",
        type: "WRITE",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "scope_difference",
        title: "セッションとリクエストスコープの違いがわかる",
        type: "KNOW",
        difficulty: Difficulty.Medium,
      },
      {
        questionId: "write_session_attributes",
        title: "@SessionAttributesでフォーム情報を保持できる",
        type: "WRITE",
        difficulty: Difficulty.Medium,
      },
      {
        questionId: "write_session_status",
        title: "SessionStatusでセッションを破棄できる",
        type: "WRITE",
        difficulty: Difficulty.Medium,
      },
      {
        questionId: "write_login_session",
        title: "セッションでログイン状態を保持できる",
        type: "WRITE",
        difficulty: Difficulty.Medium,
      },
      {
        questionId: "write_cart_session",
  ...
  withAutoIds({
    ...
    questions: [
      {
        questionId: "what_is_html",
        title: "HTMLとは何かを説明できる",
        type: "KNOW",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "what_is_tag",
        title: "タグとは何かを説明できる",
        type: "KNOW",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "opening_closing_tag",
        title: "開始タグと終了タグの役割を説明できる",
        type: "KNOW",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "block_vs_inline",
        title: "ブロック要素とインライン要素の違いを説明できる",
        type: "KNOW",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "heading_tags",
        title: "h1〜h6タグで見出しを作れる",
        type: "WRITE",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "paragraph_tag",
        title: "pタグで段落を作れる",
        type: "WRITE",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "anchor_tag",
        title: "aタグでリンクを作れる",
        type: "WRITE",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "image_tag",
        title: "imgタグで画像を表示できる",
        type: "WRITE",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "list_tags",
        title: "ulとolでリストを作れる",
        type: "WRITE",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "table_tag",
        title: "tableタグで表を作れる",
        type: "WRITE",
        difficulty: Difficulty.Medium,
      },
  ...
  withAutoIds({
    ...
    questions: [
      {
        questionId: "what_is_css",
        title: "CSSとは何かを説明できる",
        type: "KNOW",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "what_is_selector",
        title: "セレクタとは何かを説明できる",
        type: "KNOW",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "property_and_value",
        title: "プロパティと値の役割を説明できる",
        type: "KNOW",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "color_property",
        title: "colorプロパティで文字色を変えられる",
        type: "WRITE",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "font_size_property",
        title: "font-sizeプロパティで文字サイズを変えられる",
        type: "WRITE",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "background_color_property",
        title: "background-colorプロパティで背景色を変えられる",
        type: "WRITE",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "margin_property",
        title: "marginプロパティで外側の余白を調整できる",
        type: "WRITE",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "padding_property",
        title: "paddingプロパティで内側の余白を調整できる",
        type: "WRITE",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "border_property",
        title: "borderプロパティで枠線を付けられる",
        type: "WRITE",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "css_apply_methods",
  ...
  withAutoIds({
    ...
    questions: [
      {
        questionId: "what_is_flexbox",
        title: "Flexboxとは何かを説明できる",
        type: "KNOW",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "float_vs_flexbox",
        title: "floatとFlexboxの違いを説明できる",
        type: "KNOW",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "display_flex",
        title: "display: flexでFlexboxレイアウトを作れる",
        type: "WRITE",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "justify_content",
        title: "justify-contentで横方向の配置を調整できる",
        type: "WRITE",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "align_items",
        title: "align-itemsで縦方向の配置を調整できる",
        type: "WRITE",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "class_selector",
        title: "クラスセレクタを使える",
        type: "WRITE",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "id_selector",
        title: "IDセレクタを使える",
        type: "WRITE",
        difficulty: Difficulty.Easy,
      },
      {
        questionId: "descendant_selector",
        title: "子孫セレクタを使える",
        type: "WRITE",
        difficulty: Difficulty.Medium,
      },
      {
        questionId: "combined_selectors",
