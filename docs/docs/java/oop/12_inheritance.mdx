...
classDiagram
    ...
    style Employee fill:#e1f5ff,stroke:#0288d1,stroke-width:3px
    style FullTimeEmployee fill:#e8f5e9,stroke:#388e3c,stroke-width:2px
    style PartTimeEmployee fill:#e8f5e9,stroke:#388e3c,stroke-width:2px
    style ContractEmployee fill:#e8f5e9,stroke:#388e3c,stroke-width:2px
```
...
<QuestionList topicId="12_inheritance" category="java/oop" />
