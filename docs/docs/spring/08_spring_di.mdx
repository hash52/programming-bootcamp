...
<TeachingCodeBlock
  code={`// 4) コントローラ（インターフェースにのみ依存）※このコードは変えない
@Controller
public class GreetingController {
...
<QuestionList topicId="08_spring_di" category="spring" />
