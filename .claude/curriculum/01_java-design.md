...
4. **Hello World**
   ...
   - Eclipseでの実行手順
     1. 新規Javaプロジェクトを作成
     2. 新規クラスを作成（`main`メソッドを自動生成）
     3. `System.out.println("Hello World");`を書く
     4. 実行ボタンをクリック
   - `public class`、`public static void main`の説明（詳細は後の章で）
...
6. **変数のスコープ**
   ...
   ```
   - **補足:** 次章以降で、if文やfor文など複数のブロックが登場する
